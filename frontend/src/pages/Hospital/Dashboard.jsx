...
const Dashboard = ({adminSharedEmail}) => {
    ...
    const updateBedsTaken = async (change) => {
        ...
        try {
            ...
            const response = await axios.put(`${baseURL}/admin/${emailToUse}/bedsTaken/update`, { bedsTaken: newBedsTaken });
    ...
    const updateAvailableDoctors = async () => {
        ...
        const emailToUse = adminSharedEmail || savedEmail;
        try {
            await axios.put(`${baseURL}/admin/${emailToUse}/availableDoctors/update`, {
    ...
    const updateAvailableFacilities = async () => {
        ...
        const emailToUse = adminSharedEmail || savedEmail;
        try {
            await axios.put(`${baseURL}/admin/${emailToUse}/availableFacilities/update`, {
    ...
    const handleSaveAmbulances = async (newAmbulances) => {
        try {
            const response = await axios.post(`${baseURL}/ambulance/admin/assign`, {
